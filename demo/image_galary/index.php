...
<body>
	...
	?>
	<div class="container">
		<h2 style="text-align:center"  class="bg-success"> Welcome to my Image gallery </h2>
	<div class="container">
	...
	<div class="container">
		<h2 style="text-align:center"  class="bg-danger"> Image Gallery </h2>
		<div class="row">
		<?php
		...
		if (mysqli_num_rows($result) > 0) {
		    ...
		    while($row = mysqli_fetch_assoc($result)) {
		    	...
		    	$image =  "{$image}";
		        echo '<div class="col-sm-4"><img src="'.$image.'" style="width:300px;height:200px;margin-top:30px" /></div>';
		    }
		} else {
		    echo "0 results";
		}
