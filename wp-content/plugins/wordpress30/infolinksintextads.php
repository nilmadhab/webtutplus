...
function infolinks_install() {
    ...
    add_option( 'infolinks_publisherid', '2493548' );
    add_option( 'infolinks_websiteid', '0' );
	 ...
	 if( $display == 1 ){
	  $infoscript = '
		...
		<script type="text/javascript">
		   ...
		   var infolink_pid ='.absint( get_option( 'infolinks_publisherid' ) ).';
		   var infolink_wsid = '.absint( get_option('infolinks_websiteid') ).';
